    ...
    ## Date:Monday, 3rd June 2024 - 9:00 - 12:00 
    ## Professor: 包傑奇
   ...
   I use [http://www.github.com](Github) to administer the exam. 
    ...
    Questions/QDebuggingModK.ipynb

    Questions/QHOGFeatureDetector.ipynb

    Questions/QSteganography.ipynb

    Questions/QHistogram.ipynb
    ...
    1) When running the second cell, the notebook will ask you for your student id and
    student name. The prompt for the answer may be at the top of the window, when you
    use a jupyter environment. Make sure to enter the requested information in the
    right spot.

    1) Some questions ask you to enter a numerical value or a short answer. In this case,
    the correct spot for answering is marked with "ENTER VALUE HERE" and you should replace
    this string with your answer in the jupyter cell.
    ...
    1) After you answered all the questions, use the *git* command to push your changes to your repository.
       ...
       c) Use *git push* to push your changes to your forked repository. You can push
       intermediate versions as often as you like, but I will only mark the last
       one that you submitted.

       d) Create a pull request against my repository. Wait until I confirm that I have
       received the pull request.

       e) Download a zip file of your repository and save it, just in case there are any
       problem. If you have trouble with creating a proper pull request you can send me the
       zip file.
